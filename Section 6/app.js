...
var budgetController = (function(){
    ...
    return{
        ...
        // this function will be called by the Budget controller 
        deleteItem: function(type, id){
            ...
            if(index !== -1){
                // will start removing elements at index
                // and will remove x number of elements 
                // specified(1 in this case)
...
var UIController = (function(){
    ...
    return {
        ...
        deleteListItem: function(selectorID){
            // In JS, you can not delete element, only child
...
var controller = (function(budgetCtrl, UICtrl) {
    ...
    var ctrlDeleteItem = function(event){
        ...
        if(itemID){
            ...
            //inc-1
            // JS put a wrapper that changes a
            // primitive to an object
